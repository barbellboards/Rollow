...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/3.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/5.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/10.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/11.jpg?raw=true)

Continue with soldering the microcontrollers on the board.

![alt text](https://github.com/[username]/[reponame]/blob/[branch]/12.jpg?raw=true)

Finish by snipping off any excess of the the pins. 

![alt text](https://github.com/[username]/[reponame]/blob/[branch]/13.jpg?raw=true)

Remove the microcontroller and double check that all the solders look correct.
You can also remove the tape at this step.

![alt text](https://github.com/[username]/[reponame]/blob/[branch]/14.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/15.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/16.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/18.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/20.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/24.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/26.jpg?raw=true)

Finish up by soldering the other ends of the diodes to the board.

![alt text](https://github.com/[username]/[reponame]/blob/[branch]/28.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/29a.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/30.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/31.jpg?raw=true)

Lastly, solder the other end of the sockets valley.

![alt text](https://github.com/[username]/[reponame]/blob/[branch]/32.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/22b.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/22c.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/33.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/34.jpg?raw=true)
...
![alt text](https://github.com/[username]/[reponame]/blob/[branch]/35.jpg?raw=true)
